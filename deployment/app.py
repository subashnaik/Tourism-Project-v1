...
input_data = pd.DataFrame([{
    ...
    "Passport": 1 if Passport == "Yes" else 0, # To set it as 0 or 1 because the dropdown options are yes or no
    "OwnCar": 1 if OwnCar == "Yes" else 0, # To set it as 0 or 1 because the dropdown options are yes or no
